...
<Steps>
1. **外部ツールでホットリロード（v0.0.14以降）** — 手順の詳細は [Reference › Config](/ja/reference/config/#auto-reload-configuration-changes)
   ```bash
   # nodemonを使用
...
- 開発環境では nodemon や PM2 を活用し、詳細手順は [Reference › Config](/ja/reference/config/#auto-reload-configuration-changes) を参照
...
1. [GitHub Issues](https://github.com/himorishige/hatago-mcp-hub/issues)で既存の問題を検索
2. 新しいIssueを作成（エラーログを含めてください）
3. [Discussions](https://github.com/himorishige/hatago-mcp-hub/discussions)で質問
