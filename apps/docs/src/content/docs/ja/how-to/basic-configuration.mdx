...
<Aside type="tip">開発中はnodemonまたはPM2を使用した自動リロードをお勧めします。</Aside>

<Aside type="note">
  この変更により、起動時間が8.44倍高速化（85.66ms → 10.14ms）されました。
</Aside>
...
<CardGrid>
  ...
  <Card title="リモートサーバー" icon="globe" href="/ja/how-to/remote-servers/">
    HTTPやSSEサーバーとの接続
  </Card>
