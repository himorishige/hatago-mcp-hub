...
<CardGrid>
  ...
  <Card title="リモートサーバー接続" icon="globe" href="/ja/how-to/remote-servers/">
    HTTP / SSE の接続
  </Card>
...
<Aside type="tip">
  **サポート**: 問題が解決しない場合は[GitHub
  Issues](https://github.com/himorishige/hatago-hub/issues)で質問してください。
</Aside>
