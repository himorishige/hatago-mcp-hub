...
2. 個別サーバーの状態を確認
3. 設定変更時は外部ツール（nodemon/PM2）で自動再起動、または手動で再起動
...
- [設定リファレンス](/ja/reference/config/) - 高度な設定オプション
- [リモートサーバー接続](/ja/how-to/remote-servers/) - HTTPベースのMCPサーバー
- [タグベースフィルタリング](/ja/how-to/tag-filtering/) - 環境ごとのサーバー管理
