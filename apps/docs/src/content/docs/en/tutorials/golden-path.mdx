---
title: Golden Path — From Zero to Prod in ~30 Minutes
description: Integrate Hatago MCP Hub into an existing Node.js project and reach a production‑ready setup quickly
version: '0.0.2+'
...
async function verify() {
  const tests = [
    { name: 'list servers', req: { jsonrpc: '2.0', method: '_internal_hatago_list_servers', id: 1, params: {} } },
    { name: 'status',       req: { jsonrpc: '2.0', method: '_internal_hatago_status',       id: 2, params: {} } }
  ];
