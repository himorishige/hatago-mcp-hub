...
<CardGrid stagger>
  ...
  <Card title="🧰 Operations" icon="information">
    Config updates require restart; use nodemon/PM2 for auto-restart.
  </Card>
...
<CardGrid>
  <Card title="Report an Issue" icon="bug" href="https://github.com/himorishige/hatago-mcp-hub/issues">
